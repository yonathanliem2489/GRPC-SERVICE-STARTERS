...
import com.tiket.tix.train.libs.grpc.server.context.GRPCServerInitializedEvent;
import com.tiket.tix.train.libs.grpc.server.interceptor.GRPCGlobalInterceptor;
...
public class GRPCServerRunner implements SmartLifecycle {
    ...
    private ServerServiceDefinition bindInterceptors(ServerServiceDefinition serviceDefinition,
        GRPCService gRpcService, Collection<ServerInterceptor> globalInterceptors) {
