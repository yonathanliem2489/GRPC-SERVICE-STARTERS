...
import com.tiket.tix.train.libs.grpc.server.interceptor.GRPCInterceptorConfiguration;
...
public class GRPCConfiguration {
  ...
  @Bean
  @ConditionalOnProperty(value = "train.integrator.grpc.server.enabled", havingValue = "true",
      matchIfMissing = true)
